...
import Checkers.AI.AlphaBetaPrunBlack;
 ...
 * @author edwar
 */
public class BoardAIBlackController implements Initializable {
    ...
    private Piece makePiece(PieceType type, int x, int y) {
        ...
        piece.setOnMouseReleased(e -> {
            ...
            if (piece.getType() == PieceType.BLACK && !moveOrder) {
...
//                System.out.println(newPlayerMove.getMove().getNewXPost() * 100 + " " + newPlayerMove.getMove().getNewYPost() * 100);
        ...
        if (doMove(newPlayerMove.getPlayerType(), newPiece)) {
            ...
            for (int i = 0; i < whitePieceStorage.getPieceStorage().size(); i++) {
                ...
                System.out.println(whitePlayer.getPiecePositions().getPieceStorage().get(i).getOldY() == oldYPost);
                if (whitePlayer.getPiecePositions().getPieceStorage().get(i).getOldX() == oldXPost && whitePlayer.getPiecePositions().getPieceStorage().get(i).getOldY() == oldYPost) {
                    whitePlayer.getPiecePositions().getPieceStorage().get(i).movePiece(newPlayerMove.getMove().getNewXPost(), newPlayerMove.getMove().getNewYPost());
                    System.out.println("Position Updated");
                    System.out.println("New Position " + blackPlayer.getPiecePositions().getPieceStorage().get(i).getOldX() + " " + whitePlayer.getPiecePositions().getPieceStorage().get(i).getOldY());
                }
            }
        }
    }
